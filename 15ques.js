...
console.log(`"${famousPerson} once said,"I have never  failed, I've just found 10,000 ways that won't work.""`);
console.log(`\t\n`);
...
let names = [`Areesha`, `Laiba`, `Simrah`];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
// ORR:
...
let vehicles = [`honda civic`, `125 motorcycle`, `tesla`];
...
let Guests = [`Rabiya`, `Aroob`, `Areesha`];
exports.default = Guests;
Guests.forEach((guest) => {
    console.log(`Hello ${guest}, I am inviting you for the dinner at my place. I would love to spent some real time with you. `);
});
console.log(`\t\n`);
